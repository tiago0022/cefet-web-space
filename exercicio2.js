...
defineImagem(); // Garante a definição da imagem 1 e sua descrição

function defineImagem() {
  imagem.src = servidorDasImagens + '/' + imagens[indiceImagem % imagens.length].arquivo;
  imagem.alt = imagens[indiceImagem].descricao;
}
